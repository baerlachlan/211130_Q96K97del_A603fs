...
hm_gsea_eqtl$EOfADvsWT[[10]] %>%
  mutate(fdr.sig = FDR < 0.05) %>%
  dplyr::select(Pathway, pval, FDR, fdr.sig, bonf.p.adj, sig, everything())
hm_gsea_dar$EOfADvsWT %>%
  mutate(fdr.sig = FDR < 0.05) %>%
  dplyr::select(Pathway, pval, FDR, fdr.sig, bonf.p.adj, sig, everything())

hm_gsea_eqtl$MPSvsWT[[10]] %>%
  mutate(fdr.sig = FDR < 0.05) %>%
  dplyr::select(Pathway, pval, FDR, fdr.sig, bonf.p.adj, sig, everything())
hm_gsea_dar$MPSvsWT %>%
  mutate(fdr.sig = FDR < 0.05) %>%
...
kg_gsea_eqtl$EOfADvsWT[[10]] %>%
  mutate(fdr.sig = FDR < 0.05) %>%
  dplyr::select(Pathway, pval, FDR, fdr.sig, bonf.p.adj, sig, everything())
kg_gsea_dar$EOfADvsWT %>%
  mutate(fdr.sig = FDR < 0.05) %>%
  dplyr::select(Pathway, pval, FDR, fdr.sig, bonf.p.adj, sig, everything())
...
wk_gsea_eqtl$EOfADvsWT[[10]] %>%
  mutate(fdr.sig = FDR < 0.05) %>%
  dplyr::select(Pathway, pval, FDR, fdr.sig, bonf.p.adj, sig, everything()) %>%
  print(n = sum(.$fdr.sig))
wk_gsea_dar$EOfADvsWT %>%
  mutate(fdr.sig = FDR < 0.05) %>%
  dplyr::select(Pathway, pval, FDR, fdr.sig, bonf.p.adj, sig, everything()) %>%
  print(n = sum(.$fdr.sig))

wk_gsea_eqtl$MPSvsWT[[10]] %>%
  mutate(fdr.sig = FDR < 0.05) %>%
  dplyr::select(Pathway, pval, FDR, fdr.sig, bonf.p.adj, sig, everything()) %>%
  print(n = sum(.$fdr.sig))
wk_gsea_dar$MPSvsWT %>%
...
```{r}
ttdiv <- map2(topTables, masterGR, function(tt, div){
